...
一款面向大学课程安排的原生 macOS 课表应用。它把每周课程、考试、作业、校园地图和日历导出集中在一个简洁的桌面窗口中，数据默认保存在本机。
...
- 支持课程名称、教师、教室、楼栋、节次、周次和自定义颜色。
- 登录南京大学教务系统后读取课表，不会自动提交登录表单。
- 内置鼓楼校区地图，可按楼栋名称定位、居中和高亮。
- 为课程添加考试、作业与其他事项，支持完成状态及未来 7 天提醒。
- 逾期事项显示红色，当天事项显示橙色。
- 导出高清 PNG、PDF、ICS，或同步到苹果日历。
...
课程和事项保存在本机。应用不包含广告或行为分析；教务系统页面直接连接南京大学网站。详细说明见 [PRIVACY.md](PRIVACY.md)。
